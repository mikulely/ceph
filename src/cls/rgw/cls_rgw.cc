...
static int rgw_cls_bl_rm_entry(cls_method_context_t hctx, bufferlist *in, bufferlist *out)
{
  ...
  try {
    ...
    CLS_LOG(1, "ERROR: rgw_cls_bl_rm_entry(): failed to decode entry\n");
    return -EINVAL;
  }
...
CLS_INIT(rgw)
{
  ...
  /* bucket logging deliver */
  cls_register_cxx_method(h_class, "bl_set_entry", CLS_METHOD_RD | CLS_METHOD_WR, rgw_cls_bl_set_entry, &h_rgw_bl_set_entry);
  cls_register_cxx_method(h_class, "bl_rm_entry", CLS_METHOD_RD | CLS_METHOD_WR, rgw_cls_bl_rm_entry, &h_rgw_bl_rm_entry);
  cls_register_cxx_method(h_class, "bl_get_next_entry", CLS_METHOD_RD, rgw_cls_bl_get_next_entry, &h_rgw_bl_get_next_entry);
  cls_register_cxx_method(h_class, "bl_put_head", CLS_METHOD_RD| CLS_METHOD_WR, rgw_cls_bl_put_head, &h_rgw_bl_put_head);
  cls_register_cxx_method(h_class, "bl_get_head", CLS_METHOD_RD, rgw_cls_bl_get_head, &h_rgw_bl_get_head);
  cls_register_cxx_method(h_class, "bl_list_entries", CLS_METHOD_RD, rgw_cls_bl_list_entries, &h_rgw_bl_list_entries);
