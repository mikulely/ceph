...
struct cls_rgw_bl_get_next_entry_op {
  string marker;
  cls_rgw_bl_get_next_entry_op() {}
...
WRITE_CLASS_ENCODER(cls_rgw_bl_get_next_entry_op)

struct cls_rgw_bl_get_next_entry_ret {
  pair<string, int> entry;

  cls_rgw_bl_get_next_entry_ret() {}
...
WRITE_CLASS_ENCODER(cls_rgw_bl_get_next_entry_ret)

struct cls_rgw_bl_rm_entry_op {
  pair<string, int> entry;
  cls_rgw_bl_rm_entry_op() {}
...
WRITE_CLASS_ENCODER(cls_rgw_bl_rm_entry_op)
...
struct cls_rgw_bl_put_head_op {
  cls_rgw_bl_obj_head head;

  cls_rgw_bl_put_head_op() {}
...
WRITE_CLASS_ENCODER(cls_rgw_bl_put_head_op)

struct cls_rgw_bl_get_head_ret {
  cls_rgw_bl_obj_head head;

  cls_rgw_bl_get_head_ret() {}
...
WRITE_CLASS_ENCODER(cls_rgw_bl_get_head_ret)

struct cls_rgw_bl_list_entries_op {
  string marker;
  uint32_t max_entries;

  cls_rgw_bl_list_entries_op() {}
...
WRITE_CLASS_ENCODER(cls_rgw_bl_list_entries_op)

struct cls_rgw_bl_list_entries_ret {
  map<string, int> entries;

  cls_rgw_bl_list_entries_ret() {}
...
WRITE_CLASS_ENCODER(cls_rgw_bl_list_entries_ret)
