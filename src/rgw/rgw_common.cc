...
rgw_resources_map rgw_resources({
    ...
    { RGW_RESOURCE_CATEGORY_BUCKET, "BUCKET" },
    { RGW_RESOURCE_CATEGORY_IAM_ROLE, "IAM_ROLE" },
    { RGW_RESOURCE_CATEGORY_IAM_ROLES, "IAM_ROLES" },
    { RGW_RESOURCE_CATEGORY_IAM_ROLE_POLICY, "IAM_ROLE_POLICY" },
    { RGW_RESOURCE_CATEGORY_IAM_ROLE_POLICIES, "IAM_ROLE_POLICIES" },
    { RGW_RESOURCE_CATEGORY_BUCKET_STATUS, "BUCKET_STATUS" },
    { RGW_RESOURCE_CATEGORY_BUCKET_LOGGING_STATUS, "BUCKET_LOGGING_STATUS" },
    { RGW_RESOURCE_CATEGORY_BUCKET_LOCATION, "BUCKET_LOCATION" },
    { RGW_RESOURCE_CATEGORY_BUCKET_VERSIONS, "BUCKET_VERSIONS" },
    { RGW_RESOURCE_CATEGORY_BUCKET_VERSIONING, "BUCKET_VERSIONING" },
    { RGW_RESOURCE_CATEGORY_BUCKET_WEBSITE, "BUCKET_WEBSITE" },
    { RGW_RESOURCE_CATEGORY_BUCKET_MDSEARCH, "BUCKET_MDSEARCH" },
    { RGW_RESOURCE_CATEGORY_ACL, "ACL" },
    { RGW_RESOURCE_CATEGORY_CORS, "CORS" },
    { RGW_RESOURCE_CATEGORY_REQUEST_PAYMENT, "REQUEST_PAYMENT" },
    { RGW_RESOURCE_CATEGORY_UPLOADS, "UPLOADS" },
    { RGW_RESOURCE_CATEGORY_UPLOAD, "UPLOAD" },
    { RGW_RESOURCE_CATEGORY_LIFECYCLE, "LIFECYCLE" },
    { RGW_RESOURCE_CATEGORY_BUCKET_POLICY, "BUCKET_POLICY" },
    { RGW_RESOURCE_CATEGORY_DELETE_MULTI_OBJECT, "DELETE_MULTI_OBJECT"},
    { RGW_RESOURCE_CATEGORY_OBJECT, "OBJECT"},
    { RGW_RESOURCE_CATEGORY_OBJECT_LAYOUT, "OBJECT_LAYOUT"},
    { RGW_RESOURCE_CATEGORY_OBJECT_TAGGING, "OBJECT_TAGGING"},
    { RGW_RESOURCE_CATEGORY_SERVICE, "SERVICE"},
    // Swift specific resource
    { RGW_RESOURCE_CATEGORY_ACCOUNT_STATUS, "ACCOUNT_STATUS" },
    { RGW_RESOURCE_CATEGORY_BULK_UPLOAD, "BULK_UPLOAD" },
    { RGW_RESOURCE_CATEGORY_BULK_DELETE, "BULK_DELETE" },
    { RGW_RESOURCE_CATEGORY_ACCOUNT_METADATA, "ACCOUNT_METADATA" },
    { RGW_RESOURCE_CATEGORY_BUCKET_METADATA, "BUCKET_METADATA" },
    { RGW_RESOURCE_CATEGORY_OBJECT_METADATA, "OBJECT_METADATA" },
    { RGW_RESOURCE_CATEGORY_AUTH, "AUTH" },
    // Admin specific resource
    // rgw_rest_bucket.cc
    { RGW_RESOURCE_CATEGORY_BUCKET_INDEX, "BUCKET_INDEX" },
    { RGW_RESOURCE_CATEGORY_BUCKET_INFO, "BUCKET_INFO" },
    { RGW_RESOURCE_CATEGORY_BUCKET_LINK, "BUCKET_LINK" },
    // rgw_rest_usage.cc
    { RGW_RESOURCE_CATEGORY_USER_USAGE, "USER_USAGE" },
    // rgw_rest_user.cc
    { RGW_RESOURCE_CATEGORY_QUOTA, "QUOTA" },
    { RGW_RESOURCE_CATEGORY_USER_INFO, "USER_INFO" },
    { RGW_RESOURCE_CATEGORY_SUBUSER, "SUBUSER" },
    { RGW_RESOURCE_CATEGORY_KEY, "KEY" },
    { RGW_RESOURCE_CATEGORY_CAPS, "CAPS" },
    { RGW_RESOURCE_CATEGORY_USER, "USER" },
    // rgw_rest_metadata.cc
    { RGW_RESOURCE_CATEGORY_METADATA, "METADATA" },
    // rgw_rest_log.cc
    { RGW_RESOURCE_CATEGORY_MDLOG_SHARDINFO, "MDLOG_SHARDINFO" },
    { RGW_RESOURCE_CATEGORY_MDLOG_LIST, "MDLOG_LIST" },
    { RGW_RESOURCE_CATEGORY_MDLOG_STATUS, "MDLOG_STATUS" },
    { RGW_RESOURCE_CATEGORY_MDLOG_INFO, "MDLOG_INFO" },
    { RGW_RESOURCE_CATEGORY_BILOG_INFO, "BILOG_INFO" },
    { RGW_RESOURCE_CATEGORY_BILOG_LIST, "BILOG_LIST" },
    { RGW_RESOURCE_CATEGORY_DATALOG_SHARDINFO, "DATALOG_SHARDINFO" },
    { RGW_RESOURCE_CATEGORY_DATALOG_LIST, "DATALOG_LIST" },
    { RGW_RESOURCE_CATEGORY_MDLOG_STATUS, "DATALOG_STATUS" },
    { RGW_RESOURCE_CATEGORY_DATALOG_INFO, "DATALOG_INFO" },
    { RGW_RESOURCE_CATEGORY_MDLOG, "MDLOG" },
    { RGW_RESOURCE_CATEGORY_BILOG, "BILOG" },
    { RGW_RESOURCE_CATEGORY_DATALOG, "DATALOG" },
    { RGW_RESOURCE_CATEGORY_MDLOG_LOCK, "MDLOG_LOCK" },
    { RGW_RESOURCE_CATEGORY_MDLOG_UNLOCK, "MDLOG_UNLOCK" },
    { RGW_RESOURCE_CATEGORY_MDLOG_NOTIFY, "MDLOG_NOTIFY" },
    { RGW_RESOURCE_CATEGORY_DATALOG_LOCK, "DATALOG_LOCK" },
    { RGW_RESOURCE_CATEGORY_DATALOG_UNLOCK, "DATALOG_UNLOCK" },
    { RGW_RESOURCE_CATEGORY_DATALOG_NOTIFY, "DATALOG_NOTIFY" },
    // rgw_rest_opstate.cc
    { RGW_RESOURCE_CATEGORY_OPSTATE, "OPSTATE" },
    // rgw_rest_replica_log.cc
    { RGW_RESOURCE_CATEGORY_MDLOG_BOUNDS, "MDLOG_BOUNDS" },
    { RGW_RESOURCE_CATEGORY_BILOG_BOUNDS, "BILOG_BOUNDS" },
    { RGW_RESOURCE_CATEGORY_DATALOG_BOUNDS, "DATALOG_BOUNDS" },
    // rgw_rest_config.cc
    { RGW_RESOURCE_CATEGORY_ZONEGROUP_MAP, "ZONEGROUP_MAP" },
    { RGW_RESOURCE_CATEGORY_ZONE_CONFIG, "ZONE_CONFIG" },
    // rgw_rest_realm.cc
    { RGW_RESOURCE_CATEGORY_REALM, "REALM" },
    ...
    info(_cct, e)
{
  ...
  obj_ctx = NULL;
  resource = RGW_RESOURCE_CATEGORY_NONE;
}
