...
struct test_rgw_env {
  ...
  rgw_data_placement_target default_placement_id;

  test_rgw_env() {
    test_rgw_init_env(&zonegroup, &zone_params);
    default_placement_id.data_pool = rgw_pool(zone_params.placement_rules[zonegroup.default_placement_id].data_pool);
    default_placement_id.data_extra_pool = rgw_pool(zone_params.placement_rules[zonegroup.default_placement_id].data_extra_pool);
  }
