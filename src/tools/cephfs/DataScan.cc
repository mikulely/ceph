  ...
  for (; i != i_end; ++i) {
    ...
    if (accum_res.ceiling_obj_index > 0) {
      ...
      if (loaded_layout.fl_pg_pool == uint32_t(-1)
        ...
        guessed_layout.fl_object_size = g_default_file_layout.fl_object_size;
        guessed_layout.fl_stripe_unit = g_default_file_layout.fl_stripe_unit;
        guessed_layout.fl_stripe_count = g_default_file_layout.fl_stripe_count;
      } else {
        guessed_layout = loaded_layout;
      }
    }
